...
ALPHA=$1
OUTPUT_DIR="/mnt/ShareDB_6TB/datasets/FCIT_data/checkpoint/FCIT/cap-related-het/$ALPHA/Task2_llava_lora_ours"
PREVIOUS_TASK="/mnt/ShareDB_6TB/datasets/FCIT_data/checkpoint/FCIT/cap-related-het/$ALPHA/Task1_llava_lora_ours/llava_lora_finetune_epoch_9"
