...
ALPHA=$1
OUTPUT_DIR="/mnt/cache/guohaiyang/checkpoints/FCIT/task-related-het/$ALPHA/Task2_llava_lora_ours"
PREVIOUS_TASK="/mnt/cache/guohaiyang/checkpoints/FCIT/task-related-het/$ALPHA/Task1_llava_lora_ours/llava_lora_finetune_epoch_9"
