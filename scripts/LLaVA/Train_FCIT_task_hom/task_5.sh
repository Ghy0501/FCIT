...
ALPHA=$1
OUTPUT_DIR="/mnt/ShareDB_6TB/datasets/FCIT_data/checkpoint/FCIT/task-related-hom/$ALPHA/Task5_llava_lora_ours"
PREVIOUS_TASK="/mnt/ShareDB_6TB/datasets/FCIT_data/checkpoint/FCIT/task-related-hom/$ALPHA/Task4_llava_lora_ours/llava_lora_finetune_epoch_9"
...
deepspeed --include localhost:0,1,2,3 --master_port 29600 ETrain/Train/LLaVA/train_mem.py \
