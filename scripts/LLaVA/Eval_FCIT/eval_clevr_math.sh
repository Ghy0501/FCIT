...
RESULT_DIR="./results/FCIT/each_dataset/CLEVR_Math"

for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m ETrain.Eval.LLaVA.CoIN.model_clevr_math \
        --model-path $MODELPATH \
        --model-base /mnt/haiyangguo/mywork/FCIT/pre_trained/llava-v1.5-7b \
        --question-file /mnt/ShareDB_6TB/datasets/FCIT_data/instructions/CLEVR-Math/test_1w.json \
...
python -m ETrain.Eval.LLaVA.CoIN.eval_aokvqa \
    --annotation-file /mnt/ShareDB_6TB/datasets/FCIT_data/instructions/CLEVR-Math/test_1w.json \
