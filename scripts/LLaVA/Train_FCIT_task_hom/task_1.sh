...
ALPHA=$1
OUTPUT_DIR="/mnt/ShareDB_6TB/datasets/FCIT_data/checkpoint/FCIT/task-related-hom/$ALPHA/Task1_llava_lora_ours"
...
deepspeed --include localhost:0,1,2,3 --master_port 29600 ETrain/Train/LLaVA/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /mnt/ShareDB_6TB/models/llava-v1.5-7b/mm_projector.bin \
