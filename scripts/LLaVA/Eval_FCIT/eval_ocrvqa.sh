...
RESULT_DIR="./results/FCIT/each_dataset/OCRVQA"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m ETrain.Eval.LLaVA.CoIN.model_ocr_vqa \
        ...
        --question-file /mnt/ShareDB_6TB/datasets/FCIT_data/instructions/OCRVQA/test_1w.json \
...
python -m ETrain.Eval.LLaVA.CoIN.eval_iconqa \
    --annotation-file /mnt/ShareDB_6TB/datasets/FCIT_data/instructions/OCRVQA/test_1w.json \
