...
ALPHA=$1
OUTPUT_DIR="/mnt/cache/guohaiyang/checkpoints/FCIT/task-related-het/$ALPHA/Task7_llava_lora_ours"
PREVIOUS_TASK="/mnt/cache/guohaiyang/checkpoints/FCIT/task-related-het/$ALPHA/Task6_llava_lora_ours/llava_lora_finetune_epoch_9"
